  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/ViewRequiredToolReports"
          element={<ViewRequiredToolReports />}
        />
        <Route
          path="/ViewToolStatusReports"
          element={<ViewToolStatusReports />}
        />
        <Route path="/AddToolStatus" element={<AddToolStatus />} />
        <Route path="/TrackToolBoxes" element={<TrackToolboxes />} />{" "}
      </Routes>
    </>
  );
}
