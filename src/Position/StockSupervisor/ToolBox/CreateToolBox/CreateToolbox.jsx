...
function CreateToolbox() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}authentication/getUsertoolbox`);
  ...
  const fetchLatestToolboxId = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_URL}toolbox/gettoolbox`);
    ...
    if (toolbox.toolbox_id) {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_API_URL}toolbox/check/${toolbox.toolbox_id}`
        );
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}toolbox/create`, requestData);
